...
class Product {
    ...
    toggleImagesField(cb, group, input) {
        if (cb.checked) {
            ...
            document.getElementById('editProductPrice').required = false
            document.getElementById('addProductPrice').required = false
            ...
            document.getElementById('editProductPrice').required = true
            document.getElementById('addProductPrice').required = true
